...
//http://dsn-sap-dg7.dassian.loc:8000/sap/opu/odata/sap/ZUSER_SRV/USR01Set?$format=json&sap-ds-debug=true&$filter=startswith%28NameFirst,%27A%27%29&$skip=12&$top=5#sec1
...
function dataRequest(){
  var build = '';
  OData.read({
    requestUri: "https://cors-anywhere.herokuapp.com/services.odata.org/Northwind/Northwind.svc/",
    method: "GET",
    ...
    function (data, response) {
      ...
      //data.d.results
        _.each(data.workspaces[0].collections, function(product){
